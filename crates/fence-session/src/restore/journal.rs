...
pub(super) struct RestoreJournal {
    ...
    #[serde(default)]
    pub(super) worktree_root: Option<fence_core::NativeString>,
    #[serde(default)]
...
pub(super) struct IndexRestoreJournal {
    ...
    pub(super) worktree_key: Option<String>,
    #[serde(default)]
    pub(super) index_path: Option<fence_core::NativeString>,
    #[serde(default)]
...
pub(super) struct BatchRestoreJournal {
    ...
    #[serde(default)]
    pub(super) transaction_id: Option<Uuid>,
    pub(super) worktree_root: fence_core::NativeString,
...
pub(super) enum JournalNode {
    ...
    Symlink {
        target: fence_core::NativeString,
        windows_link_kind: Option<fence_core::WindowsSymlinkKind>,
    },
    EmptyDirectory,
}
...
impl JournalNode {
    ...
    fn to_entry(&self, path: &NativeRelativePath) -> ManifestEntry {
        ...
        ManifestEntry {
            path: path.clone(),
            node,
            safety: fence_core::SafetyObservations::default(),
        }
    }
}
