//! Safety-reviewed Win32 filesystem primitives used by Fence.
//!
...
pub enum WindowsError {
    ...
    /// A bounded native query exceeded Fence's safety limit.
    #[error("{0} exceeds Fence's bounded query limit")]
    TooLarge(&'static str),
