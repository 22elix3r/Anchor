...
impl PlanPresence {
    ...
    fn path_encoding(&self) -> anchor_core::PathEncoding {
        match self {
...
fn host_encoding_tag() -> u8 {
    encoding_tag(anchor_core::PathEncoding::host())
}

fn encoding_tag(encoding: anchor_core::PathEncoding) -> u8 {
    match encoding {
...
fn decode_encoding(tag: u8) -> anchor_core::PathEncoding {
    match tag {
        2 => anchor_core::PathEncoding::WindowsWtf16Le,
        _ => anchor_core::PathEncoding::UnixBytes,
    }
}
...
mod tests {
    ...
    use anchor_git::RepositoryState;
    ...
    fn repository() -> RepositoryState {
        RepositoryState {
            head: anchor_git::HeadState::Unborn {
                referent: b"refs/heads/main".to_vec(),
            },
            operation: anchor_git::OperationState::None,
